...
public class TourGuideService {
    ...
    WebClient rewardClient = WebClient.create("http://" + rewardUrlBase);

    @Value("${tracker.url}")
    private String trackerUrlBase;

    WebClient trackerClient = WebClient.create("http://" + trackerUrlBase);
    ...
    public VisitedLocation trackUserLocation(User user) {
        ...
        //rewardClient.get().uri("/calculateRewards").attribute("user", user);
        rewardsService.calculateRewards(user);
        rewardsService.calculateRewardsEnd();
        try {
            executorTourGuideService.awaitTermination(24, TimeUnit.HOURS);
    ...
    public Future<VisitedLocation> trackUserLocationThread(User user) {
        return executorTourGuideService.submit(() -> {
